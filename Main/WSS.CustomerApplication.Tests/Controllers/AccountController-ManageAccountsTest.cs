...
namespace WSS.CustomerApplication.Tests.Controllers
{
    ...
    public class AccountControllerManageAccountsTest
    {
        ...
        public AccountControllerManageAccountsTest()
        {
            ...
            _accountController = new AccountController(wssUnitOfWork.Object, ubUnitOfWork.Object, mapper, auditTransaction, null);
        ...
        [TestMethod]
        public void CustomerDeleteLinkedUtilityAccountAccIdDoesNotExist()
        {
            var result = _accountController.DeleteLinkedUtilityAccount(0, 0);
        ...
        [TestMethod]
        public void CustomerDeleteLinkedUtilityAccountAccIdExists()
        {
            var result = _accountController.DeleteLinkedUtilityAccount(1, 0);
            Assert.IsNotNull(result);
            var expected = ((JsonResult)result).Data.ToString();
            Assert.IsNotNull(expected);
        }
        ...
        public void UpdateLinkedUtilityAccountAccIdDoesNotExist()
        {
            ...
            Assert.IsNotNull(result);
            var expected = ((JsonResult)result).Data.ToString();
            Assert.AreEqual(expected, "{ isUpdated = False, result =  }");
        }
        ...
        public void UpdateLinkedUtilityAccountAccIdExists()
        {
            ...
            Assert.IsNotNull(result);
            var expected = ((PartialViewResult)result);
            Assert.AreEqual(expected.ViewName, "_manage");
        }
    }
}