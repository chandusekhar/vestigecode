...
namespace WSS.CustomerApplication.Tests.Controllers
{
    ...
    public class AccountControllerChangeEmailTests
    {
        ...
        public AccountControllerChangeEmailTests()
        {
            ...
            _accountController = new AccountController(_mockWssUnitOfWork.Object, _mockUtilityUnitOfWork.Object,
                _mockMapper.Object, _mockAuditTransaction.Object, _mockEmailService.Object);
            ...
            httpCnxt.Setup(m => m.Response).Returns(response.Object);
            session.Setup(m => m["SelectedUtilityAccountId"]).Returns("1");
        ...
        public void ChangeEmailTest()
        {
            ...
            objAccountController.SetFieldOrProperty("_wssAuthenticationManager", _mockAuthenticationManager.Object);
        ...
        [TestMethod]
        public void ChangeEmailWithExistingAccountTest()
        {
            // ----------
            // Act
            // ----------
        ...
        [TestMethod]
        public void ChangeEmailWithExistingEmailTest()
        {
            // ----------
            // Act
            // ----------
            object[] args = { "test@test.com", It.IsAny<int>() };
